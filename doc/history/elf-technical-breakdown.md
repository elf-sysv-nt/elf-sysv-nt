...
The design of record is `doc/design/Architecture.md`. This is the founding
survey it grew out of, kept as the reasoning that opened the project rather
than as a statement of what the system is; where the two disagree,
`Architecture.md` is current and this is history.
...
`elfsysv1.dll` sits outside the contract. `doc/design/target-definition.md`
states that bound and is the place to cite for it.
