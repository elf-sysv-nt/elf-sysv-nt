# The veneer's roadmap

History, not design. This was `doc/ROADMAP.md` from 2026-08-29 to
2026-09-06: the order of construction for the veneer arc, in which a
Cygwin-derived runtime faced as `elfsysv1.dll` was to carry el8's userland.
Proposal 0011 replaced that arc, DR-0097 retired its records, and DR-0103
retired this document with proposal 0013; the order of work is 0011 § 18
and the page that replaced this one points at it. The text below is as it
was, work-package numbers and all, kept because the dependency reasoning
between layers is worth reading and because its "Not verified" section is
an honest list of what that design never measured.
