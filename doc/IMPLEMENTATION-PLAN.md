...
reproduces el8's glibc 2.28 arithmetic verbatim (DR-0008) and `veneer/t/ftm-diff`
...
superseded; it diverged on the untested combinations (DR-0008 lists them), which
