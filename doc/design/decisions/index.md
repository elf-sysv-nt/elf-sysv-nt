...
| [0110](0110-the-libgcc-selection-is-measured-not-dumped.md) | the generated specs file takes `*libgcc` from what the driver passes, not from `-dumpspecs`, which prints it unrewritten; verified over every arm and both drivers; DR-0108's mechanism amended | provisional 2026-09-15 | none |
| [0111](0111-the-gate-address-is-a-symbol-libc-exports.md) | the gate address reaches a program through `_dl_sysinfo`, a symbol libc exports, because the two alternatives cannot be made correct; settled at tier 1 on spike 55 rather than escalated | provisional 2026-09-16 | none |
