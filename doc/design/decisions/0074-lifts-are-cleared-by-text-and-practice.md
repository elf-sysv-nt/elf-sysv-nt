...
down. Its table moves, in substance, into this record and
`doc/design/licensing.md`; the note stays as the working history behind them.

Each lift into the runtime still pays the mechanics `AGENTS.md` already
asks for: notices retained unmodified, a row in `doc/design/licensing.md`'s
