...
Proposal: `doc/history/design-gaps/proposal.md`, finding F7

## What was decided

Every decision record from DR-0008 through DR-0035 is ratified. Each was run
against `doc/design/decision-ladder.md`; each records a decision the ladder
reaches before tier 8 — correctness-first or settled on a measurement, none a
guess, each naming the basis it was taken on. None is reopened.
