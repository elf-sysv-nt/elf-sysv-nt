...
DR-0006 reserved the reading of WP-43's measured cost against bands, so the
flag could not come off on an expensive repair. That door is closed: the
reservation cost read a median of −0.49% of a delivery, inside the under-5%
band, with the repair contained in the delivery site. Run through
`doc/design/decision-ladder.md` the reading resolves at tier 1, faithfulness,
to a single survivor -- retire -- without reaching tier 8. The cost only
confirmed there was no reason to keep the flag; the reason to drop it is the
mandate.
