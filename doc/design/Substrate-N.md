...
| `tp_set` / `substrate_thread_pointer` | a runtime-owned word reached through `%gs` (DR-0003), because the FS base does not survive a deschedule | 1 (`fs-base-persistence`), 6 (`gs-thread-pointer`) |
